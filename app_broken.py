...
code = r'''from flask import Flask, request, jsonify, session, render_template_string
import sqlite3
import requests
import secrets
import os
...
.login-left{
 ...
 padding:38px 5vw;border-right:1px solid rgba(130,150,255,.14);
}
.login-right{
...
/* ---------- LOGIN CARD ---------- */
.card{
 width:min(480px,100%);padding:40px;border-radius:24px;
 background:rgba(9,13,24,.9);border:1px solid #283249;
...
<section class="login-left">
 ...
 <div class="brand">
   ...
   <div class="brand-name">Spark.ai</div>
 </div>
 <div class="tagline">Your AI. Your Spark.</div>

 <div class="hero">
   <h1>Think Smart.<br><span class="gradient">Spark More.</span></h1>
   <p>
     Your intelligent AI assistant for study, coding, creativity,
     gaming, football and everyday questions.
   </p>

   <div class="features">
     <div class="feature">
       ⚡<b>Smart Answers</b><small>Fast and useful</small>
     </div>
     <div class="feature">
       🧠<b>Memory</b><small>Remember what matters</small>
     </div>
     <div class="feature">
       🛡️<b>Private</b><small>Your own account</small>
     </div>
   </div>
 </div>
 ...
 <div class="watch">
   ...
   <div class="case">
    <div class="face">
      ...
      <div class="tick t5"></div><div class="tick t6"></div>
      <div class="tick t7"></div><div class="tick t8"></div>
      <div class="tick t9"></div><div class="tick t10"></div>
      <div class="tick t11"></div><div class="tick t12"></div>
      <div class="watch-title">SPARK.AI</div>
      <div class="watch-sub">YOUR AI • YOUR SPARK</div>
      <div class="watch-date" id="watchDate">01</div>
 ...
 <div class="footer">© 2026 Spark.ai • Your AI. Your Spark.</div>
...
<section class="login-right">
 ...
 <div class="card">
   <h2>Welcome Back!</h2>
   <div class="welcome">Log in to continue to <b style="color:#9075ff">Spark.ai</b></div>

   <div class="label">Username</div>
   <input id="username" class="field" placeholder="Enter your username"
   ...
   <div class="password">
     ...
     <button class="eye" onclick="togglePassword()">◉</button>
   </div>
   ...
   <button class="secondary" onclick="socialLogin()">
     Continue with a connected account
   </button>

   <button class="create" onclick="register()">
     Create new account
   </button>
