...
app_code = r'''from flask import Flask, request, jsonify, session, render_template_string
import sqlite3
import requests
import secrets
import os
...
base = Path("/mnt/data")
app_path = base / "spark_app.py"
req_path = base / "requirements_spark.txt"
...
print("Spark.ai login + live watch + 21-second timeout version is ready.")
